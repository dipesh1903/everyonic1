...
(function ($, undefined) {
    ...
    $.widget('sjaakp.telex', {
        ...
        _leading: null,
        _create: function() {
            $('<style>').text('.telex{overflow: hidden;white-space: nowrap;}.telex-inner{line-height:1px; padding:0;width: 60000px;}.telex-msg{display: inline-block;height: 100%;}.telex{background-color: #E95546;}.telex-msg{padding-left: 1.5em;padding-right: 1.5em;}').insertBefore($('[rel=stylesheet]').first());
            this._inner = $('<div>', {
                class: 'telex-inner'
            });
